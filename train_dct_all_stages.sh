...
# Multi-stage training script for DCT kernel
...
echo "=========================================="
echo "Starting Multi-Stage DCT Training"
echo "=========================================="

# Configuration files
STAGE1_CONFIG="./configs/training_config_dct_stage1.yaml"
STAGE2_CONFIG="./configs/training_config_dct_stage2.yaml"
STAGE3_CONFIG="./configs/training_config_dct_stage3.yaml"
...
# Optional: generate hydra_dct_mark.pt if missing (requires models/hydra_bert_23layers.pt)
if [ ! -f "./models/hydra_dct_mark.pt" ]; then
    echo "Creating hydra_dct_mark.pt via transfer..."
...
if [ -d "./checkpoints/hydra_mark" ]; then
    ...
    echo "Stage 1 checkpoint backed up to: ./checkpoints/hydra_mark_dct_stage1"
fi
...
if [ -d "./checkpoints/hydra_mark" ]; then
    ...
    echo "Stage 2 checkpoint backed up to: ./checkpoints/hydra_mark_dct_stage2"
fi
...
if [ -d "./checkpoints/hydra_mark" ]; then
    ...
    echo "Stage 3 checkpoint backed up to: ./checkpoints/hydra_mark_dct_stage3"
fi
...
echo "  - Stage 1: ./checkpoints/hydra_mark_dct_stage1"
echo "  - Stage 2: ./checkpoints/hydra_mark_dct_stage2"
echo "  - Stage 3: ./checkpoints/hydra_mark_dct_stage3"
